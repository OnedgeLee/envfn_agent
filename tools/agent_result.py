...
column_names = {
    'total': 'Whole Building:Facility Total Electric Demand Power [W](Hourly)',
    'hvac': 'Whole Building:Facility Total HVAC Electric Demand Power [W](Hourly)',
    'ite' : 'Whole Building:Facility Total Building Electric Demand Power [W](Hourly)',
    'pue' : 'EMS:Power Utilization Effectiveness [](TimeStep)',
    'westemp' : 'WEST ZONE:Zone Air Temperature [C](TimeStep)',
    'eastemp' : 'EAST ZONE:Zone Air Temperature [C](TimeStep)',
    'outemp' : 'Environment:Site Outdoor Air Drybulb Temperature [C](TimeStep)',
...
output_names = {
    ...
    'hvac': 'HVAC_Total_Power_Consumption',
    'ite': 'ITE_Total_Power_Consumption',
    'pue': 'Power_Utilization_Effectiveness',
    'westemp' : 'West_Zone_Temperature',
    'eastemp' : 'East_Zone_Temperature',
    'outemp' : 'Outdoor_Temperature',
...
def compare_before_after(type,dirname,logidx):
    ...
    data = select_columns_from_files(
        file_paths=[ '/hdd/project/datacenter/tmpeplog/output/episode/eplusout_ours.csv', eplusout_path + '/eplusout_last.csv', eplusout_path + '/eplusout_base.csv'],
...
if __name__ == '__main__':
    ...
    # compare_before_after('total', args.dir, args.idx)
    # compare_before_after('hvac', args.dir, args.idx)
    # compare_before_after('ite', args.dir, args.idx)
    # compare_before_after('westemp', args.dir, args.idx)
    # compare_before_after('eastemp', args.dir, args.idx)
    # compare_before_after('outemp', args.dir, args.idx)
    # compare_before_after('pue', args.dir, args.idx)
